          ...
          <CardContent>
            <form>
              <Grid container spacing={5}>
                ...
                <Grid item xs={12}>
                  <FormControl>
                    <FormLabel id='demo-radio-buttons-group-label'>Show Result</FormLabel>
                    <RadioGroup
                      aria-labelledby='demo-radio-buttons-group-label'
                      defaultValue='Yes'
                      name='radio-buttons-group'
                    >
                      <FormControlLabel value='Yes' control={<Radio />} label='Immediately after test submission' />
                      <FormControlLabel value='No' control={<Radio />} label='Manually at later date' />
                      <FormControlLabel value='No' control={<Radio />} label='On Date' />
                    </RadioGroup>
                  </FormControl>
                </Grid>
                <Grid item xs={12}>
